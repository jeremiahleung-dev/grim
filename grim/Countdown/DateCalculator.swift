...
struct DateCalculator {
    ...
    static func remaining(dob: Date, lifeExpectancy: Int, unit: DisplayUnit) -> Int {
        switch unit {
        case .days:  return daysRemaining(dob: dob, lifeExpectancy: lifeExpectancy)
        case .weeks: return weeksRemaining(dob: dob, lifeExpectancy: lifeExpectancy)
        case .years: return Int(yearsRemaining(dob: dob, lifeExpectancy: lifeExpectancy))
        }
    }
